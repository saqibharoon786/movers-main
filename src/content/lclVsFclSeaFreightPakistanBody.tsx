    ...
    <>
      <nav className="not-prose mb-8 p-4 bg-muted/50 rounded-xl">
        ...
        <ul className="space-y-1 text-sm text-muted-foreground">
          ...
          <li><a href="#faqs" className="hover:text-foreground">Frequently Asked Questions — LCL vs FCL</a></li>
        </ul>
      </nav>
      ...
      <h2>20. Frequently Asked Questions — LCL vs FCL Sea Freight from Pakistan</h2>
      <p>These are the most searched questions about LCL vs FCL from Pakistan — answered in complete detail:</p>

      <InfoBox variant="blue">
        <strong>Q: What is the difference between LCL and FCL in sea freight?</strong>
        <p className="mt-2">LCL (Less than Container Load) means your cargo shares a shipping container with other shippers' goods. You pay per CBM (cubic meter) of space used. FCL (Full Container Load) means you book an entire container — either 20ft or 40ft — exclusively for your cargo. You pay a flat rate per container regardless of how full it is. LCL is more flexible and economical for small volumes; FCL is faster, more secure, and cheaper per CBM for large volumes.</p>
      </InfoBox>

      <InfoBox variant="blue">
        <strong>Q: When should I choose FCL over LCL from Pakistan?</strong>
        <p className="mt-2">Choose FCL when your cargo exceeds approximately 14–16 CBM on UAE routes, 12–14 CBM on UK/Europe routes, or 13–15 CBM on USA/Canada routes. Above these volumes, FCL is typically cheaper per CBM than LCL — and is always faster and more secure. Also choose FCL for temperature-controlled cargo (reefer), dangerous goods, vehicles, high-value goods where contamination risk is unacceptable, and pharmaceutical products.</p>
      </InfoBox>

      <InfoBox variant="blue">
        <strong>Q: How do I calculate CBM for LCL shipping from Pakistan?</strong>
        <p className="mt-2">CBM = Length (metres) × Width (metres) × Height (metres). Measure your cargo including packaging. For multiple pieces, calculate each piece separately and sum the totals. Round up to 2 decimal places. Minimum charge is typically 1 CBM even if your cargo is smaller. For irregularly shaped cargo, use the dimensions of the bounding box (smallest box that fully contains the item). Submit accurate measurements to your forwarder — under-declaration leads to amended invoices on delivery.</p>
      </InfoBox>

      <InfoBox variant="blue">
        <strong>Q: What is the LCL rate from Karachi to Dubai in 2026?</strong>
        <p className="mt-2">LCL ocean freight rates from Karachi to Jebel Ali (Dubai) are approximately USD 45–75 per CBM in 2026. However, this is the ocean freight component only. A complete all-in door-to-door rate from Karachi to a Dubai address adds: origin CFS handling, customs documentation, destination handling, UAE customs clearance, and delivery — bringing total cost to approximately USD 120–180 per CBM all-in, or AED 440–660 per CBM. Always request an all-in quote for accurate comparison.</p>
      </InfoBox>

      <InfoBox variant="blue">
        <strong>Q: How long does LCL shipping take from Karachi to Dubai?</strong>
        <p className="mt-2">LCL shipping from Karachi to Dubai takes approximately 10–18 days door-to-door. This includes: 2–4 days for LCL consolidation at Karachi CFS, 3–6 days ocean transit to Jebel Ali, 2–4 days UAE customs clearance and de-consolidation at Jebel Ali CFS, and 1–2 days final delivery within UAE. FCL shipping is faster — approximately 7–12 days door-to-door — because there is no consolidation or de-consolidation delay.</p>
      </InfoBox>

      <InfoBox variant="blue">
        <strong>Q: Can I mix different types of cargo in an LCL shipment?</strong>
        <p className="mt-2">Yes, LCL allows you to include different types of cargo in a single shipment — clothing, household items, electronics, kitchenware — as long as none of the items are classified as dangerous goods (DG), require temperature control, or are prohibited. Your packing list must accurately describe all items. However, you cannot mix regular cargo with DG cargo in LCL — DG must be handled separately and most LCL operators will not consolidate DG with general cargo.</p>
      </InfoBox>

      <InfoBox variant="blue">
        <strong>Q: Is FCL cheaper than LCL for large shipments from Pakistan?</strong>
        <p className="mt-2">Yes. For any shipment exceeding 14–16 CBM on the Pakistan–UAE route, FCL 20ft is almost always cheaper than LCL on a per-CBM basis. At 20 CBM going to Dubai: LCL at USD 55/CBM = USD 1,100 ocean freight; FCL 20ft at USD 500 = USD 500 for the whole container — that is 55% cheaper with FCL. On top of the cheaper ocean rate, FCL also saves on LCL-specific charges like CFS stuffing and NVOCC fees. Always get both LCL and FCL quotes when your volume is above 10 CBM.</p>
      </InfoBox>

      <InfoBox variant="blue">
        <strong>Q: Which is safer — LCL or FCL for valuable cargo from Pakistan?</strong>
        <p className="mt-2">FCL is safer for valuable cargo. In FCL, your container is sealed at origin and not opened until the destination — no other cargo enters, no additional handling at CFS facilities. In LCL, your cargo is handled at origin CFS (loaded into container with others), and at destination CFS (unloaded and sorted). Each additional handling stage is an opportunity for damage or theft. For high-value goods, luxury items, pharmaceuticals, or fragile cargo, FCL provides significantly better security. If LCL is the only viable option due to volume, use comprehensive All Risks (ICC A) insurance.</p>
      </InfoBox>
